...
### How might this look like:
 ...
 - The [prototype](https://utherii.github.io/new2.html) help and options button are not real buttons but images with hover popup. I just did it that way to go faster, it is not intended to replace buttons.
